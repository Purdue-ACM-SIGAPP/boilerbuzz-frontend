...
// Make filler posters
export function makeRandomPosters(baseCount: number, howMany: number, seed = 42): PosterData[] {
    ...
    <Animated.View style={[styles.wrap, { transform: [{ scale }] }]}>
      ...
      >
        <Image
          ...
          // ever want to preserve the original poster size, you can use
          // cover instead of stretch
          resizeMode="contain"
        />
      </TouchableOpacity>
    </Animated.View>
