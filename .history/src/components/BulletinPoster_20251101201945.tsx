 ...
 * On press, will auto-navigate using poster_data.link unless autoNavigate={false}.
...
type Props = {
  ...
  onPressAfterNavigate?: (poster_data: PosterData) => void;
};
...
export default function BulletinPoster({
  ...
  const handlePress = () => {
    ...
    onPressAfterNavigate?.(poster_data);
  };
  ...
  return (
    <Animated.View style={[styles.wrap, { transform: [{ scale }] }]}>
      <TouchableOpacity
        ...
        onPress={handlePress}
        activeOpacity={0.9}
        accessibilityLabel={poster_data.title}
      >
        <Image
          source={poster_data.image}
