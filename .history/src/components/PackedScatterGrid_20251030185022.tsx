...
/*
 * I couldn't get the library I wanted to work, so I decided to
 * just take some code from a library already made and have AI
 * optimize it so that it fit what I already had made.
 */
