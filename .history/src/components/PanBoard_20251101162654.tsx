...
/**
 * PanBoard:
 *  - Provides a pannable "canvas" region (canvasWidth x canvasHeight).
 *  - Clamps panning so the canvas edges cannot be dragged past the viewport edges.
 *  - Centers the starting position by default.
 *
 *  NOTE: PanBoard knows NOTHING about how children are arranged; it only pans the canvas.
 */
