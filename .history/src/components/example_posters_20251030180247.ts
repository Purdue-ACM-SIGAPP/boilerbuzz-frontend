...
export type PosterMeta = {
  id: string;
  title: string;
  image: ImageSourcePropType; // local require(...) or { uri }
  likes: number;              // used to size the poster
  link: PosterLink;           // where to navigate on press
};

// Handy size helper reused by the board
...
// ---- Example preset posters (edit this list freely) ----
export const POSTERS: PosterMeta[] = [
  ...
  },
  {
    ...
    image: require("../../assets/tempposter.png"),
    likes: 175,
    link: { type: "stack", name: "Profile" }, // stack-level Profile
  },
  {
    id: "p10",
    title: "Career Fair",
